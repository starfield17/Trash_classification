...
项目提供多个YOLO系列模型，适应不同场景需求：

```
yolo11n.pt  yolo11s.pt    # YOLOv11模型
yolov10n.pt yolov10s.pt   # YOLOv10模型
yolov9s.pt  yolov9t.pt    # YOLOv9模型
yolov8n.pt  yolov8s.pt    # YOLOv8模型
```
...
### 速度对比（从快到慢）
1. YOLOv9-t
2. YOLOv11-n/YOLOv10-n
3. YOLOv9-s
4. YOLOv8-n
5. YOLOv11-s/YOLOv10-s
6. YOLOv8-s
...
```python
# train4class_yolovX_easydata.py
select_model = 'yolo11n.pt'  # 修改为需要的模型
```
